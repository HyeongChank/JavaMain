...
public class Test20_DateFormat {

	public static void main(String[] args) throws ParseException {
		Date date = new Date();
		SimpleDateFormat f1 = new SimpleDateFormat("hh 'o''clock' a, zzz");
		SimpleDateFormat f2 = new SimpleDateFormat("K:mm a, z");
		SimpleDateFormat f3 = new SimpleDateFormat("yy년 MM월 E요일 hh시 mm분 ss초 a");
		...
		System.out.println(f5.format(date2));
